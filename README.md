...
| `automation/scripts/` | Planned validation, packaging, install, and publish scripts |
...
1. Author or update a template under `templates/`
2. Validate it locally using `local_testing/`
3. Update any relevant documentation
4. Package templates into `artifacts/nuget_packages/`
...
Use `local_testing/` for disposable test output while validating templates.
